...
_JDS_FMT = """executable = /cms/ldap_home/molamolabb/delPhys/bin/slc6_amd64_gcc630/doubleHiggsAnalyser
universe   = vanilla
...
def main():
    ...
    out_dir = 'root://cms-xrdr.private.lo:2094///xrd/store/user/jua/doubleHiggs/1-Analyser/'+data_name
