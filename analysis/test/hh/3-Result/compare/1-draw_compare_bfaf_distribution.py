...
hlist = {"bfc":{"tt":dict(),"tt_ditau":dict(),"tt_leptau":dict(),"tatabb":dict(), "ttv":dict(),"tth":dict(),"twj":dict(), "llbj":dict(), "hh":dict()},
          "afc":{"tt":dict(),"tt_ditau":dict(),"tt_leptau":dict(),"tatabb":dict(), "ttv":dict(),"tth":dict(),"twj":dict(), "llbj":dict(), "hh":dict()}}
...
f_after  = ROOT.TFile("/cms/ldap_home/molamolabb/delPhys/src/delphys/analysis/test/hh/3-Result/afterCut/distribution.root")
f_before = ROOT.TFile("/cms/ldap_home/molamolabb/delPhys/src/delphys/analysis/test/hh/3-Result/beforeCut/distribution.root")
cvs = ROOT.TCanvas()
cvs.SetGrid()
...
scale = {"tt"       :13026.59269/hlist["afc"]["tt"]["mT"].GetEntries(),
         "tt_ditau" :3536.845092/hlist["afc"]["tt_ditau"]["mT"].GetEntries(),
         "tt_leptau":14091.76248/hlist["afc"]["tt_leptau"]["mT"].GetEntries(),
