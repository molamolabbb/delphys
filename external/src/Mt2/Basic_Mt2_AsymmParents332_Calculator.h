...
#ifndef Basic_Mt2_AsymmParents332_Calculator_H
#define Basic_Mt2_AsymmParents332_Calculator_H

#include "Mt2_AsymmParents332_Calculator.h"
#include "Minuit2/FCNBase.h"
#include <vector>

namespace Mt2 {

  class Basic_Mt2_AsymmParents332_Calculator : public Mt2_AsymmParents332_Calculator {
  public:
    double mt2_AsymmParents332(const double theta,//tan(theta)=mHeavyA/mHeavyB
    ...
    double mt2_AsymmParents332_Sq(const double theta,//tan(theta)=mHeavyA/mHeavyB
                       const LorentzTransverseVector& visibleA, // 3 d.o.f. 
		      const LorentzTransverseVector& visibleB, // 3 d.o.f.
		      const TwoVector& ptmiss,                 // 2 d.o.f.
		      const double mInvisible);
    Basic_Mt2_AsymmParents332_Calculator() : Mt2_AsymmParents332_Calculator("Basic_Mt2_AsymmParents332") {};
